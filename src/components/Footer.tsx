      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xl font-semibold">
                <span className="text-white">OWSH</span>{" "}
                <span className="text-white/60">Studio</span>
              </span>
            </Link>
            <p className="text-white/50 max-w-md mb-6">
              Beautiful websites for local businesses. Free to build, simple
              monthly subscription. Based in Buffalo, NY.
            </p>
            <div className="flex gap-4">
              <motion.a
                ...
                aria-label="Follow OWSH Studio on Instagram"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow OWSH Studio on Facebook"
                whileHover={{ scale: 1.1 }}
                className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors"
              >
                <svg
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow OWSH Studio on LinkedIn"
                whileHover={{ scale: 1.1 }}
                className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors"
              >
                <svg
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white/30 text-sm">
            © {new Date().getFullYear()} OWSH Studio. Built different.
          </p>
