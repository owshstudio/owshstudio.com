          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Link href={`/work/${project.id}`} className="group block">
                <div className="relative aspect-[21/9] rounded-2xl overflow-hidden gradient-border mb-8">
                  {project.image ? (
                    <Image
                      src={project.image}
                      alt={project.title}
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-owsh-dark via-owsh-dark/50 to-transparent" />
